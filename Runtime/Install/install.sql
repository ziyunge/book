...
(1, 'Gxl有声小说系统', 'http://', 'http://www.gxlnet.com', 1, 1);
...
(23, 0, 23, 2, '有声资讯', 'pp_newslist', 'pp_vod', 'pp_play', 'pp_vodtype', 'xinwenzixun', 1, '', '', '', ''),
(15, 2, 15, 1, '奇幻玄幻', 'pp_vodlist', 'pp_vod', 'pp_play', 'pp_vodtype', 'qihuanyuanhuan', 1, '', '', '', 'http://'),
(8, 1, 8, 1, '都市言情', 'pp_vodlist', 'pp_vod', 'pp_play', 'pp_vodtype', 'dushiyanqing', 1, '', '', '', 'http://'),
(2, 0, 1, 1, '男频', 'pp_vodchannel', 'pp_vod', 'pp_play', 'pp_vodtype', 'nanpin', 1, '', '', '', 'http://'),
(1, 0, 2, 1, '女频', 'pp_vodchannel', 'pp_vod', 'pp_play', 'pp_vodtype', 'nvpin', 1, '', '', '', '');
