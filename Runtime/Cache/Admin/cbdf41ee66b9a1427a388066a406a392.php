...
<div class="tophr">
    ...
    <div class="right"><a href="http://www.gxlnet.com/" target="_blank">官方论坛</a> |<a href="?s=Admin-Cache-Del" target='right' id="clear" title="包括模板,数据库等系统缓存">清空缓存</a> <a id="cache"></a> | <a href="?s=Admin-Index" target='_top'>后台首页</a> | <a href="<?php echo C("site_path");?>" target="_blank">网站首页</a> | <a href="?s=Admin-Login-Logout" target="_top">注销退出</a></div>
</div>
</body>
</html>